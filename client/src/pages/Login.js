...
console.log(check);
return ( <
    div class = "flex min-h-full max-w-7xl flex-col justify-items-center mx-auto" >
    <
    ...
    <
    a href = "/signup"
    className = "text-[#539e60] font-semibold" > Sign Up < /a> <
    /div> <
    /div>
    ...
    <
    div className = "bg-green-100 w-1/2  mt-12 rounded" >
    ...
    required class = "block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-3 " /
    >
    <
    /div> <
    /div>
    ...
    {
        error && ( <
            p className = "text-red-500 text-sm mb-2 bg-red-100 py-2 px-3 rounded-lg font-semibold tracking-wide" > { error } <
            /p>
        )
    }
