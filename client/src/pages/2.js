...
export const ModelDetail2 = () => {
  ...
  const handleDownload = () => {
    const fileUrl = '/model.stl'; // Replace with your file path
    const link = document.createElement('a');
    link.href = fileUrl;
    link.setAttribute('download', 'model.stl'); // Replace with your file name
  ...
  const images = {
    image1: "/models/bench.jpg",
    image2: "/models/bench2.jpg",
  };
        ...
        <div className="max-w-7xl mx-auto mt-4">
          <div className="flex">
            ...
            <div className="w-1/2 ml-4 mt-14">
              <div className="flex items-center justify-between">
                <h1 className="text-3xl font-semibold">Old Wooden Bench</h1>
              ...
              <div className="mt-4">
                ...
                <p className="text-justify">
                  Widespread weathered rustic wooden bench, which is aged, old
                  and worn out, and which displays worn details from past use.
                  Empty wooden park bench with worn out planks, which is worn
                  out, antique, ancient and which is aged outdoor sitting. For
                  garden equipment, ancient architecture styles, rustic style
                  props, antique bench constructions, outdoor furniture, wooden
                  outdoor furniture, equipment for recreation, and garden
                  furniture promotional projects. Old Wooden Bench is a high
                  quality, photo real 3d model that will enhance detail and
                  realism to any of your rendering projects. The model has a
                  fully textured, detailed design that allows for close-up
                  renders, and was originally modeled in 3ds Max 2014 and
                  rendered with V-Ray. Renders have no postprocessing! Hope you
                  like it!
                </p>
              </div>
              ...
              <a href="#" className="flex items-center gap-2 mt-6">
                ...
                className="w-48 bg-[#539e60] text-white font-medium py-2 rounded-lg ">
                  Download Free
                </button>
